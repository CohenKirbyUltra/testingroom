...
hoversfxs = [
  "../audio/ui/sfx_rrui_watch_ui_button_hover_general_01",
  "../audio/ui/sfx_rrui_watch_ui_button_hover_general_02",
  "../audio/ui/sfx_rrui_watch_ui_button_hover_general_03",
  "../audio/ui/sfx_rrui_watch_ui_button_hover_general_04",
  "../audio/ui/sfx_rrui_watch_ui_button_hover_general_05",
  "../audio/ui/sfx_rrui_watch_ui_button_hover_general_06",
];

releasesfxs = [
  "../audio/ui/sfx_rrui_watch_ui_select_up_01",
  "../audio/ui/sfx_rrui_watch_ui_select_up_02",
  "../audio/ui/sfx_rrui_watch_ui_select_up_03",
  "../audio/ui/sfx_rrui_watch_ui_select_up_04",
  "../audio/ui/sfx_rrui_watch_ui_select_up_05",
  "../audio/ui/sfx_rrui_watch_ui_select_up_06",
];
